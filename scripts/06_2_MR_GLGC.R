...
save(myMRTab,file = paste0("../temp/06_MR_input_GLGC_",tag2,".RData"))
load(paste0("../temp/06_MR_input_GLGC_",tag2,".RData"))
...
save(myMRTab,file = paste0("../results/06_MR_WaldEstimates_GLGC_",tag2,".RData"))
...
save(myMRTab_results,file = paste0("../results/06_MR_IVWEstimates_GLGC_",tag2,".RData"))
...
myTab[,rank := c(6,5,8,2,3,1,4,7,6,5,8,2,3,1,4,7)]
setorder(myTab, rank,-setting)

filename1 = paste0("../figures/MRPlots/06_MR_ForerstPlots_acrossPhenos_inclEgger_GLGC_",tag2,".tiff")
...
filename2 = paste0("../figures/MRPlots/06_MR_ForerstPlots_acrossPhenos_GLGC_",tag2,".tiff")
...
for(i in 1:8){
  ...
  filename1 = paste0("../figures/MRPlots/06_MR_ForerstPlots",myPhenos[i],"_GLGC_",tag2,".tiff")
...
save(IATab_IVW, file = paste0("../results/06_MR_InteractionTest_GLGC_",tag2,".RData"))
...
tiff(filename = paste0("../figures/MRPlots/06_InteractionScatterPlot_GLGC_",tag2,".tiff"),
